...
rhos = [1., 5., 10., 20., 50., 100., 200., 500., 1000.]
for rho in rhos:
    all_params_and_data['rho'] = rho
    ...
    for aa in range(agent_samples):
        plt.plot(range(len(wasserstein_dists[aa])), wasserstein_dists[aa], label="ρ="+str(rho))
